...
(function($, document, window, undefined) {
  ...
  Verify.prototype = {
    ...
    */
    ...
    init: function(options) {
        var customValidations = options.validations,
            customMessages = options.messages,
            key;

        for(key in customValidations) {
            this.addValidation(key, customValidations[key]);
        }
    ...
    addMessage: function(key, message, type) {
        ...
        if(typeof type !== 'undefined' && type === true) {
            this.message.type[key] = message;
            return;
        }

        if(key === 'type') {
            for(var i in message) {
                this.message.type[i] = message[i];
            }
  ...
  ValidatorField.prototype = {
      ...
      init: function(element, type) {
          ...
          //overfiden bu validatorMultiple if radio or check inputs
      ...
      addConstraint: function(constraint, doNotUpdateValidationEvents) {
          ...
          for(var name in constraint) {
              ...
              if(typeof this.Verify.verifies[name] !== 'undefined') {
      ...
      destroy: function() {
          this.$element.removeClass(this.namespace);
  ...
  Validator.prototype = {
      ...
      whichType: function(elem) {
        ...
        if($elem.is('form') || $elem.data('bind') === true) {
            this.newInstance = this.bind($elem, 'validatorForm');
        } else if ($elem.is(this.inputs) && !$elem.is(this.removes)) {
            this.newInstance = this.bind($elem, !$elem.is(this.radioOrCheckbox) ? 'validatorField' : 'validatorFieldMultiple');
        }
      ...
      bind: function(elem, type) {
          ...
          if(!validatorInstance) {
            ...
            $(elem).data(type, validatorInstance);
